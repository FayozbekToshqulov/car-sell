                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {car.map(item => (
                        <div key={item.id} className="max-w-sm rounded overflow-hidden shadow-lg">
                            ...
                            <div className="px-6 py-4">
                                <Button className="border px-4 py-2 bg-red-500 text-white rounded-lg mr-2" onClick={() => handleDelete(item.id)}>Delete</Button>
                                <Button className="border px-4 py-2 bg-orange-500 text-white rounded-lg" onClick={() => handleEdit(item.category, item.description, item.img, item.id, item.price)}>Edit</Button>
                            </div>
                        </div>
                    ))}
                </div>
